...
{
    DirectionalLightSample::DirectionalLightSample(_In_ PCWSTR pszGameName)
        ...
        , m_transformMatrix()
    {
        m_transformMatrix.World = XMMatrixIdentity();
    }
    ...
    void DirectionalLightSample::InitDevice()
    {
        RECT rc;
        ...
        // Create a root signature.
        {
            ...
            rootParameters[1].InitAsConstants(sizeof(TransformMatrix) / 4, 0, 0, D3D12_SHADER_VISIBILITY_VERTEX);
    ...
    void DirectionalLightSample::CleanupDevice()
    {
    ...
    void DirectionalLightSample::Update(FLOAT deltaTime)
    {
        // Update the model matrix.
        const XMVECTOR rotationAxis = XMVectorSet(0, 1, 1, 0);
        m_transformMatrix.World *= XMMatrixRotationAxis(rotationAxis, -2.0f * deltaTime);

        // Update the view matrix.
        const XMVECTOR eyePosition = XMVectorSet(0, 0, -10, 1);
        const XMVECTOR focusPoint = XMVectorSet(0, 0, 0, 1);
        const XMVECTOR upDirection = XMVectorSet(0, 1, 0, 0);
        m_transformMatrix.View = XMMatrixLookAtLH(eyePosition, focusPoint, upDirection);
        ...
        m_transformMatrix.Projection = XMMatrixPerspectiveFovLH(XMConvertToRadians(45.0f), aspectRatio, 0.1f, 100.0f);
    }

    void DirectionalLightSample::Render()
    {
        ...
        m_commandList->SetGraphicsRoot32BitConstants(1, sizeof(TransformMatrix) / 4, &m_transformMatrix, 0);
